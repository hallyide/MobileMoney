...
<div class="card card-pad form-page">
    <form method="post" action="<?= site_url('client/' . $compte['id'] . '/transfert') ?>">
        <div class="field">
            <label for="numeroDestinataire">Numéro du destinataire</label>
            <input class="input input-mono" id="numeroDestinataire" name="numero"
                   value="<?= esc(old('numero')) ?>" placeholder="ex : 0332345678"
        ...
        <div class="field">
            ...
            <input class="input input-mono" type="number" min="100" max="2000000" step="1"
                   id="montantTransfert" name="montant" value="<?= esc(old('montant')) ?>" placeholder="0" required>
        </div>
...
(function () {
    ...
    const input = document.getElementById('montantTransfert');
